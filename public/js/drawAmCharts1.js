...
am4core.ready(function () {
    ...
    chart1 = am4core.create("visulizationdiv1", am4charts.PieChart)

    var title = chart1.titles.create();
    title.text = "How many times do you go to the Karaoke every month:";
    title.fontSize = 20;
    title.marginTop = 30;

    // Add and configure Series
    var pieSeries = chart1.series.push(new am4charts.PieSeries());
    pieSeries.dataFields.value = "timeselect";
    pieSeries.dataFields.category = "times";
